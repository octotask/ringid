    ...
    <form id="valid_news" method="post" action='<?=site_url($action)?>' enctype ="multipart/form-data">
        <table width="100%" border="0" cellspacing="3" cellpadding="2">
            ...
            <tr>
                ...
                <td><input type='text' name='news_title'id ="news_title" value="<?=$news_title ?>" class='text required ui-widget-content ui-corner-all width_250' /><?=form_error('news_title', '<span>', '</span>')?></td>
            </tr>
            <tr>
                ...
                <td><textarea name='news_description' id= "content" rows="10" cols="50" class="tinymce"><?=$news_description?></textarea><?=form_error('news_description', '<span>', '</span>')?></td>
                    ...
                    <tr>
                        ...
                        <td><input type ="radio" name="status" value="1" checked />Publish &nbsp;<input type ="radio" name="status" value="0" <?php if($status==0){echo 'checked';}?>/> Not Publish </td>
            </tr>
